...
pylonsd keys add jose --keyring-backend=test --home=$HOME/.pylonsd --recover <<< "pencil shiver original sauce thank real stick armed inform cradle very elder drink planet scheme assault test science kite better chronic visa village order"
...
pylonsd add-genesis-account $(pylonsd keys show jose -a --keyring-backend=test --home=$HOME/.pylonsd) 10000000000pylon,1000000000node0token,1000000000stake,10000000loudcoin
